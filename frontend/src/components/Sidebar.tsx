    ...
    >
      <div className="flex flex-col h-full w-full">
        ...
        <button
          ...
          className="flex items-center justify-center gap-2 h-11 border-t border-border text-text-muted hover:text-text-highlight transition-colors cursor-pointer"
        >
          {collapsed ? (
