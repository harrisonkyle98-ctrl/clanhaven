...
export default function Sidebar() {
  ...
  return (
    <aside
      ...
      `}
    >
      <div className="flex flex-col h-full w-full overflow-y-auto overflow-x-visible">
        {/* Brand */}
        ...
        <nav className="py-2 px-2.5 space-y-1">
        ...
        {/* Account section */}
        <div className={ribbonClass}>{collapsed ? "" : "Account"}</div>
        <div className="py-2 px-2.5 space-y-1">
          {user ? (
            <>
        ...
        {/* System section */}
        <div className={ribbonClass}>{collapsed ? "" : "System"}</div>
