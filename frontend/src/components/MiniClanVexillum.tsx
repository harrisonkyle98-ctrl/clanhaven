  ...
  return (
    ...
    >
      ...
      <g filter="url(#vex-shadow)">
        ...
        <rect x="6" y="17.5" width="12" height="20" fill={secondaryColor} />
        <rect x="6" y="17.5" width="12" height="20" fill="url(#border-grad)" />
        {/* Main banner — primary fill inset */}
        <rect x="7" y="18.5" width="10" height="18" fill={primaryColor} />
        <rect x="7" y="18.5" width="10" height="18" fill="url(#banner-grad)" />
        <rect x="7" y="18.5" width="10" height="18" fill="url(#cloth-sheen)" />

        {/* Lower crossbar for large banner — no spear points, sits below banner */}
        <rect x="5" y="37.5" width="14" height="1" rx="0.3" fill={accentColor} />
        <rect x="5" y="37.5" width="14" height="1" rx="0.3" fill="url(#crossbar-grad)" />
      </g>
    </svg>
  )
}
