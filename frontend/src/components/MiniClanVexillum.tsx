  ...
  return (
    ...
    >
      ...
      <g filter="url(#vex-shadow)">
        ...
        <rect x="4" y="16.5" width="16" height="1" rx="0.3" fill={accentColor} />
        <rect x="4" y="16.5" width="16" height="1" rx="0.3" fill="url(#crossbar-grad)" />
        ...
        <rect x="4" y="37.5" width="16" height="1" rx="0.3" fill={accentColor} />
        <rect x="4" y="37.5" width="16" height="1" rx="0.3" fill="url(#crossbar-grad)" />
      </g>
    </svg>
  )
}
