  ...
  return (
    ...
    >
      ...
      <g filter="url(#vex-shadow)">
        ...
        {/* Horizontal crossbar */}
        <rect x="2" y="5" width="20" height="1.5" rx="0.4" fill={accentColor} opacity="0.75" />
        <rect x="2" y="5" width="20" height="1.5" rx="0.4" fill="url(#crossbar-grad)" />
        {/* Crossbar end caps */}
        <circle cx="2.5" cy="5.75" r="1" fill={accentColor} opacity="0.8" />
        <circle cx="21.5" cy="5.75" r="1" fill={accentColor} opacity="0.8" />

        {/* Two small top banners — secondary border, primary fill */}
        {/* Left small banner — border */}
        <rect x="3.5" y="6" width="7" height="10" fill={secondaryColor} />
        {/* Left small banner — primary fill inset */}
        <rect x="4.5" y="7" width="5" height="8" fill={primaryColor} />
        <rect x="4.5" y="7" width="5" height="8" fill="url(#banner-grad)" />
        <rect x="4.5" y="7" width="5" height="8" fill="url(#cloth-sheen)" />

        {/* Right small banner — border */}
        <rect x="13.5" y="6" width="7" height="10" fill={secondaryColor} />
        {/* Right small banner — primary fill inset */}
        <rect x="14.5" y="7" width="5" height="8" fill={primaryColor} />
        <rect x="14.5" y="7" width="5" height="8" fill="url(#banner-grad)" />
        <rect x="14.5" y="7" width="5" height="8" fill="url(#cloth-sheen)" />
